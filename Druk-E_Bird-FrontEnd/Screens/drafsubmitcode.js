...
function NotSubmitted() {
  ...
  const renderItem = ({ item }) => {
    console.log("Status:", item.StartbirdingData[0].status === "draftchecklist");
  console.log("User ID:", item.userId === userId);
    if (
  ...
  console.log("Filtered items:", notsubmittedChecklistItems);
